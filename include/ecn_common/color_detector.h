#ifndef ECN_COMMON_COLORDETECTOR_H
#define ECN_COMMON_COLORDETECTOR_H
...
public:
  ...
  bool process(const cv::Mat &_im, cv::Mat &_im_processed)
  {
    return process(_im, _im_processed, true);
  }
...
protected:    
  ...
  bool process(const cv::Mat &_im, cv::Mat &_im_processed, bool write_output);

};
}

#endif // ECN_COMMON_COLORDETECTOR_H
