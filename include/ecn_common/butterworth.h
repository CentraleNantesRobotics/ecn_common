#ifndef ECN_COMMON_BUTTERWORTH_H
#define ECN_COMMON_BUTTERWORTH_H
...
// this class implements a 2nd-order Butterworth low-pass filter for nD-variables (std::vectors, Eigen lib vectors...)
...
#endif // ECN_COMMON_BUTTERWORTH_H
